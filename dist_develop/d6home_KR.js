...
D6.consSeason.titleList[3] = "여름";
	...
	D6.scenario.defMeasures['mTOsolar'] = { mid:"1",  name:"mTOsolar",  title:"태양 광 발전을 설치하는",  easyness:"0.5",  refCons:"consTotal",  titleShort:"태양 광 발전", level:"",  figNum:"25",  lifeTime:"20",  price:"400000",  roanShow:"",  standardType:"",  subsidy :"",  advice:"발전 남은 전기는 전력 회사에 높게 매입 해받을 수 있습니다. 2018 년도는 1kWh 당 28 엔 (도쿄 전력, 중부 전력, 간사이 전력의 경우) 또는 30 엔 (그렇지 전력 회사는 높지만 태양이 잉여가 된 때 매입을 중단하는 장치의 설치 가 필요합니다). 패널을 설치하는 것만으로 발전이되고, 모터 등 가동 부분이 없기 때문에 수명이 길고 유지 관리도 비교적 적습니다. 교류로 변환하는 「컨디셔너 '라는 장치는 10 년 정도마다 교체해야합니다. <br> 또한 태양 광 발전 장치를 도입하면 전기를 판매 모습이 표시되는 장치가 설치됩니다. 전기를 얼마나 발전 할 수 있었는지, 집에서 얼마나 소비했는지가 표시되며, 모델에 따라 시간대별로 표시되는 것도 있습니다. 판매 할 수있는 금액도 표시되고 더 판매하기 위해 자연과 전기 사용량이 줄어드는 효과도 나옵니다.",   lifestyle:"",   season:"wss"};
	D6.scenario.defMeasures['mTOhems'] = { mid:"2",  name:"mTOhems",  title:"HEMS 장치를 설치하는",  easyness:"1",  refCons:"consTotal",  titleShort:"HEMS 장치", level:"",  figNum:"3",  lifeTime:"20",  price:"200000",  roanShow:"",  standardType:"",  subsidy :"",  advice:"HEMS는 가정에서 사용하는 전기를 시간마다 세세하게 파악하고, 에어컨 등의 가전 제품을 에너지 절약을 위해 자동 제어 할 수있는 시스템입니다. 전기 사용 등의 특징을 체크하면 어떤 일을하면 에너지 절약으로 이어질지 포인트가 보입니다. 표시되는 그래프를 바탕으로 언제 전기 소비가 많은 것인지, 무엇이 원인인지 생각해보십시오.",   lifestyle:"",   season:"wss"};
	D6.scenario.defMeasures['mTOsolarSmall'] = { mid:"3",  name:"mTOsolarSmall",  title:"베란다에 태양 광 패널을 넣어",  easyness:"2",  refCons:"consTotal",  titleShort:"베란다 태양", level:"",  figNum:"25",  lifeTime:"10",  price:"50000",  roanShow:"",  standardType:"",  subsidy :"",  advice:"태양해도 지붕에 설치하는 것이 아니라 휴대 할 수있는 소형 패널을 베란다 등에 두는 것으로, 조명 등 작은 용도로 사용할 수 있습니다. 기성품으로 판매되는 것도 있지만, 스스로 만들 수 재료는 인터넷 쇼핑몰과 홈 센터에서 조달 할 수 있습니다. <br> 맑은 날에는 이불을 널 같은 감각으로 햇빛에 대고 배터리를 충전시켜 충전 된 분으로 활용할 수 있습니다. 흐린 날 등은 전기를 사용할 수없는 경우가 있습니다.",   lifestyle:"",   season:"wss"};
	...
	D6.scenario.defMeasures['mHWecojoze'] = { mid:"102",  name:"mHWecojoze",  title:"온수기 에코 조스 (잠열 회수 형)에 교체하는",  easyness:"2",  refCons:"consHWsum",  titleShort:"에코 죠즈", level:"",  figNum:"10",  lifeTime:"10",  price:"200000",  roanShow:"",  standardType:"既存型",  subsidy :"",  advice:"에코 조스 (잠열 회수 형)은 수증기로 도망 열을 회수하는 구조 때문에 기존의 가스 온수기에 비해 효율이 10 % 이상 향상하고 있습니다. 기존의 가스 온수기와 비슷한 형태이지만, 열 회수를 위해 약간 대형되어 있으며 열을 회수 할 때 발생하는 물을 흘려 드레인도 붙어 있습니다. 가스 회사에 따라서는 에코 조스 요금에 따라 유가가 할인되는 경우도 있습니다.",   lifestyle:"",   season:"wss"};
	D6.scenario.defMeasures['mHWecofeel'] = { mid:"103",  name:"mHWecofeel",  title:"온수기 에코 필 (잠열 회수 형)에 교체하는",  easyness:"1",  refCons:"consHWsum",  titleShort:"에코 필", level:"",  figNum:"10",  lifeTime:"10",  price:"250000",  roanShow:"",  standardType:"既存型",  subsidy :"",  advice:"에코 필 (잠열 회수 형)은 수증기로 도망 열을 회수하는 구조 때문에 효율이 10 % 이상 향상하고 있습니다. 기존의 등유 보일러와 비슷한 형태이지만, 열 회수를 위해 약간 대형되어 있으며 열을 회수 할 때 발생하는 물을 흘려 드레인도 붙어 있습니다. 등유가 아닌 가스의 종류는 '에코죠스'라고합니다.",   lifestyle:"",   season:"wss"};
	D6.scenario.defMeasures['mHWenefarm'] = { mid:"105",  name:"mHWenefarm",  title:"온수기를 네팜 (연료 전지)에 교체하는",  easyness:"0.5",  refCons:"consHWsum",  titleShort:"네팜", level:"5",  figNum:"10",  lifeTime:"10",  price:"1200000",  roanShow:"1",  standardType:"エコジョーズ",  subsidy :"",  advice:"네팜는 연료 전지로 발전을하면서 물을 끓이는 효율이 좋은 장치입니다. 가정에서 소비하는 전기만큼 발전하고, 발생한 열을 온수로 모아 사용할 수 있습니다. 전기와 물을 많이 사용하는 가정에서 큰 에너지 절약 효과를 기대할 수 있습니다.",   lifestyle:"",   season:"wss"};
	D6.scenario.defMeasures['mHWsolarHeater'] = { mid:"106",  name:"mHWsolarHeater",  title:"태양열 온수기 (자연 순환 식)를 설치하여 이용하는",  easyness:"1",  refCons:"consHWsum",  titleShort:"태양열 온수기", level:"",  figNum:"9",  lifeTime:"10",  price:"400000",  roanShow:"",  standardType:"",  subsidy :"",  advice:"따뜻한 날씨 맑은 날이면 태양의 열기에 끓인 물을 그냥 목욕 수 있습니다. 겨울에도 가온하여 사용할 수 있으며, 물 에너지 소비를 크게 줄일 수 있습니다. 비교적 간단한 구조로 물을 끓이는 수 유효한 온난화 대책으로서 전 세계적으로 사용이 확대되고 있습니다.",   lifestyle:"",   season:"wss"};
	D6.scenario.defMeasures['mHWsolarSystem'] = { mid:"107",  name:"mHWsolarSystem",  title:"태양열 시스템 (강제 순환 식)를 설치하여 이용하는",  easyness:"1",  refCons:"consHWsum",  titleShort:"태양열 시스템", level:"",  figNum:"9",  lifeTime:"10",  price:"600000",  roanShow:"",  standardType:"",  subsidy :"",  advice:"저탕 탱크를 지상에두고 이용하는 태양열 온수기입니다. 지붕에 탱크가 없기 때문에 부하가 걸리지 않습니다. 따뜻한 날씨 맑은 날이면 태양의 열기에 끓인 물을 그냥 목욕 수 있습니다. 겨울에도 가온하여 사용할 수 있으며, 물 에너지 소비를 크게 줄일 수 있습니다. 비교적 간단한 구조로 물을 끓이는 수 유효한 온난화 대책으로서 전 세계적으로 사용이 확대되고 있습니다.",   lifestyle:"",   season:"wss"};
	D6.scenario.defMeasures['mHWshowerHead'] = { mid:"108",  name:"mHWshowerHead",  title:"절수 샤워 헤드를 장착하여 사용하는",  easyness:"5",  refCons:"consHWshower",  titleShort:"절수 샤워 헤드", level:"",  figNum:"11",  lifeTime:"10",  price:"2000",  roanShow:"",  standardType:"",  subsidy :"",  advice:"샤워 손잡이 (헤드) 부분을 대체 할 수있게되어 있습니다. 뜨거운 물이 나오는 구멍을 작게하고 있으며, 힘차게 물이 나올 수밖에 수중에 지수있는 것도 있고, 30 % 정도 물 사용을 줄일 수 있습니다. 인테리어 및 가전 양판점 등에서 구입할 수 있습니다.",   lifestyle:"1",   season:"wss"};
	...
	D6.scenario.defMeasures['mCKdishWasher'] = { mid:"118",  name:"mCKdishWasher",  title:"식기 세척기를 사용",  easyness:"2",  refCons:"consHWdishwash",  titleShort:"식기 세척기", level:"",  figNum:"15",  lifeTime:"10",  price:"80000",  roanShow:"",  standardType:"",  subsidy :"",  advice:"식기를 물에 흘려 씻어하는 데 비해, 물을 모아 세척하고 있기 때문에, 식기 세척 건조기 쪽이 에너지 절약이됩니다.なおお湯가 아닌 물로 씻는 경우는 식기 세척기보다 에너지 절약이됩니다. 화장실에서 연구하는 것도 효과적인 방법입니다.",   lifestyle:"",   season:"wss"};
	...
	D6.scenario.defMeasures['mHWreplaceToilet5'] = { mid:"120",  name:"mHWreplaceToilet5",  title:"절수 화장실을 설치하는",  easyness:"1",  refCons:"consHWtoilet",  titleShort:"절수 화장실", level:"",  figNum:"19",  lifeTime:"10",  price:"30000",  roanShow:"",  standardType:"既存型",  subsidy :"",  advice:"화장실 본체를 건설하고 교체해야하지만, 물의 양을 이전보다 절반 이하로 줄일 수 있습니다. 이전 13 리터 정도 필요했던 것이, 4-6 리터 정도에서 사용할 수 있도록되어 있으며, 수도 요금을 크게 줄일 수 있습니다.",   lifestyle:"",   season:"wss"};
	D6.scenario.defMeasures['mHWreplaceToilet'] = { mid:"121",  name:"mHWreplaceToilet",  title:"순간 식 온수 세정 변기에 사서 바꾸는",  easyness:"1",  refCons:"consHWtoilet",  titleShort:"순간 식 변기", level:"",  figNum:"19",  lifeTime:"10",  price:"30000",  roanShow:"",  standardType:"既存型",  subsidy :"",  advice:"신제품은 에너지 절약 기능이있어 뚜껑을 연 순간에 따뜻하게 타입 등 소비 전력이 줄어 듭니다. 카탈로그에 표시되는 연간 소비 전력량을 참고로 에너지 절약을 선택하십시오.",   lifestyle:"",   season:"wss"};
	...
	D6.scenario.defMeasures['mACreplace'] = { mid:"201",  name:"mACreplace",  title:"에어컨을 에너지 절약형으로 사서 바꾸는",  easyness:"1",  refCons:"consAC",  titleShort:"에너지 절약 에어컨", level:"",  figNum:"1",  lifeTime:"10",  price:"160000",  roanShow:"",  standardType:"",  subsidy :"",  advice:"같은 단지 냉난방을해도 15 년에 비해 절반 정도의 전력으로 사는 에너지 절약 성능이 높은 에어컨이 있습니다. 선택할 때에는 통일 절약 라벨의 ★ 마크의 수가 많은 것이나 연간 전기 요금 표시를 참고로 에너지 절약을 선택하십시오. 난방 성능도 높아지고 있으며, 가스 나 등유 난방에 비해 CO2를 줄일 수 있습니다.",   lifestyle:"",   season:"wss"};
	D6.scenario.defMeasures['mACreplaceHeat'] = { mid:"202",  name:"mACreplaceHeat",  title:"에어컨을 에너지 절약형으로 교체, 에어컨와 발열",  easyness:"2",  refCons:"consAC",  titleShort:"에너지 절약 에어컨 + 난방", level:"",  figNum:"1",  lifeTime:"10",  price:"160000",  roanShow:"",  standardType:"",  subsidy :"",  advice:"같은 단지 냉난방을하여 15 년에 비해 절반 정도의 전력으로 사는 에너지 절약 성능이 높은 에어컨이 있습니다. 에어컨 실외기의 열을 이용하기 위해 가스 나 등유 등 난방과 비교해도 CO2 배출량이 줄어 듭니다. 선택할 때에는 통일 절약 라벨의 ★ 마크의 수가 많은 것이나 연간 전기 요금 표시를 참고로 에너지 절약을 선택하십시오.",   lifestyle:"",   season:"wss"};
	...
	D6.scenario.defMeasures['mHTwindowSheet'] = { mid:"208",  name:"mHTwindowSheet",  title:"난방시 창문 용 단열 시트를 붙이는",  easyness:"3",  refCons:"consACheat",  titleShort:"창문 단열 시트", level:"",  figNum:"4",  lifeTime:"3",  price:"3000",  roanShow:"",  standardType:"",  subsidy :"",  advice:"창문 용 단열 시트 (소위 프티 시트 같은 건 액션 타입의 것)는 홈 센터 등에서 판매되고 있습니다. 창문을 깨끗이 닦고 분무기를 걸어 그 물만 창에 붙여 넣을 수 있습니다. 단열 효과가있을뿐만 아니라 결로도 억제 할 수 있습니다. 창문에서 불어 내려 오는 차가운 바람도 누그러 져 편안함을 향상시킵니다.",   lifestyle:"",   season:"wss"};
	D6.scenario.defMeasures['mHTdouble'] = { mid:"209",  name:"mHTdouble",  title:"창문 샷시를 복층 유리하기",  easyness:"1",  refCons:"consACheat",  titleShort:"복층 유리", level:"5",  figNum:"4",  lifeTime:"30",  price:"100000",  roanShow:"",  standardType:"",  subsidy :"家の窓全体の断熱工事をする場合、工事にかかった費用に応じて、固定資産税の控除や、ローン残高に応じた所得税控除の制度があります。",  advice:"난방시 창문과 창틀에서 도망 열 비율이 많은 일반 싱글 유리를 복층 유리로 대체하는 것은 열이 빠져 나가기 방법을 절반 정도로 줄일 수 있습니다. 에너지 절약뿐만 아니라 결로가 세우시고된다는 장점도 있습니다. 창문에서 불어 내려 오는 차가운 바람도 누그러 져 편안함을 향상시킵니다. 가옥에 따라 방법이 있으므로 공무점와 상담하십시오.",   lifestyle:"",   season:"wss"};
	D6.scenario.defMeasures['mHTlowe'] = { mid:"210",  name:"mHTlowe",  title:"창문 샷시를 수지 프레임 low-E 유리하기",  easyness:"1",  refCons:"consACheat",  titleShort:"수지 프레임 low-E 유리", level:"",  figNum:"4",  lifeTime:"30",  price:"150000",  roanShow:"",  standardType:"",  subsidy :"家の窓全体の断熱工事をする場合、工事にかかった費用に応じて、固定資産税の控除や、ローン残高に応じた所得税控除の制度があります。",  advice:"난방시 창문과 창틀에서 도망 열 비율이 많은 일반 싱글 유리를 복층 유리로 대체하는 것은 열이 빠져 나가기 방법을 절반 정도로 줄일 수 있습니다. 에너지 절약뿐만 아니라 결로가 세우시고된다는 장점도 있습니다. 창문에서 불어 내려 오는 차가운 바람도 누그러 져 편안함을 향상시킵니다. 가옥에 따라 방법이 있으므로 공무점와 상담하십시오.",   lifestyle:"",   season:"wss"};
	D6.scenario.defMeasures['mHTuchimado'] = { mid:"211",  name:"mHTuchimado",  title:"내 창 설치",  easyness:"2",  refCons:"consACheat",  titleShort:"내창", level:"5",  figNum:"4",  lifeTime:"30",  price:"60000",  roanShow:"",  standardType:"",  subsidy :"家の窓全体の断熱工事をする場合、工事にかかった費用に応じて、固定資産税の控除や、ローン残高に応じた所得税控除の制度があります。",  advice:"난방시 창문과 창틀에서 도망 열 비율이 많은 현재의 창문과 창틀 안쪽에 추가하고 '내창」을 붙이는 것으로 더 열이 도망 어렵습니다. 내창은 상대적으로 공사비가 저렴하고 약 1 시간 공사도 완료, 결로 방지 및 방범에도 효과가 있습니다. 자세한 내용은 공무점와 상담하십시오.",   lifestyle:"",   season:"wss"};
	D6.scenario.defMeasures['mHTdoubleGlassAll'] = { mid:"212",  name:"mHTdoubleGlassAll",  title:"모든 객실의 창문 유리를 복층 유리로 대체",  easyness:"1",  refCons:"consHTsum",  titleShort:"전체 거실을 복층 유리에", level:"",  figNum:"4",  lifeTime:"30",  price:"100000",  roanShow:"",  standardType:"",  subsidy :"家の窓全体の断熱工事をする場合、工事にかかった費用に応じて、固定資産税の控除や、ローン残高に応じた所得税控除の制度があります。",  advice:"난방시 창문과 창틀에서 도망 열 비율이 많은 일반 싱글 유리를 복층 유리로 대체하는 것은 열이 빠져 나가기 방법을 절반 정도로 줄일 수 있습니다. 에너지 절약뿐만 아니라 결로가 세우시고된다는 장점도 있습니다. 창문에서 불어 내려 오는 차가운 바람도 누그러거나 겨울 이른 아침 추위가 개선되거나 같은 편안함을 향상시킵니다. 가옥에 따라 방법이 있으므로 공무점와 상담하십시오.",   lifestyle:"",   season:"wss"};
	D6.scenario.defMeasures['mHTuchimadoAll'] = { mid:"213",  name:"mHTuchimadoAll",  title:"모든 방에 内窓를 설치",  easyness:"1",  refCons:"consHTsum",  titleShort:"전체 거실을 내창에", level:"",  figNum:"4",  lifeTime:"30",  price:"100000",  roanShow:"",  standardType:"",  subsidy :"家の窓全体の断熱工事をする場合、工事にかかった費用に応じて、固定資産税の控除や、ローン残高に応じた所得税控除の制度があります。",  advice:"난방시 창문과 창틀에서 도망 열 비율이 많은 현재의 창문과 창틀 안쪽에 추가하고 '내창」을 붙이는 것으로 더 열이 도망 어렵습니다. 내창은 상대적으로 공사비가 저렴하고 약 1 시간 공사도 완료, 결로 방지 및 방범에도 효과가 있습니다. 창문에서 불어 내려 오는 차가운 바람도 일본에서 겨울 이른 아침 추위가 개선되거나 같은 편안함을 향상시킵니다. 자세한 내용은 공무점와 상담하십시오.",   lifestyle:"",   season:"wss"};
	D6.scenario.defMeasures['mHTloweAll'] = { mid:"214",  name:"mHTloweAll",  title:"모든 객실의 창문 샷시를 수지 프레임 low-E 유리하기",  easyness:"1",  refCons:"consHTsum",  titleShort:"전체 거실을 수지 프레임 low-E 유리에", level:"",  figNum:"4",  lifeTime:"30",  price:"150000",  roanShow:"",  standardType:"",  subsidy :"家の窓全体の断熱工事をする場合、工事にかかった費用に応じて、固定資産税の控除や、ローン残高に応じた所得税控除の制度があります。",  advice:"난방시 창문과 창틀에서 도망 열 비율이 많은 일반 싱글 유리를 복층 유리로 대체하는 것은 열이 빠져 나가기 방법을 절반 정도로 줄일 수 있습니다. 에너지 절약뿐만 아니라 결로가 세우시고된다는 장점도 있습니다. 창문에서 불어 내려 오는 차가운 바람도 누그러거나 겨울 이른 아침 추위가 개선되거나 같은 편안함을 향상시킵니다. 가옥에 따라 방법이 있으므로 공무점와 상담하십시오.",   lifestyle:"",   season:"wss"};
	...
	D6.scenario.defMeasures['mDRheatPump'] = { mid:"402",  name:"mDRheatPump",  title:"히트 펌프 식 의류 건조기가있는 세탁기에 사서 바꾸는",  easyness:"1",  refCons:"consDRsum",  titleShort:"히트 펌프 건조", level:"",  figNum:"16",  lifeTime:"10",  price:"140000",  roanShow:"",  standardType:"",  subsidy :"",  advice:"의류 건조기 및 건조 기능 세탁기에서 히트 펌프 식의 것은 일반 건조기에 비해 에너지 소비가 절반 정도하면됩니다. 잘 건조 기능을 이용하는 경우에는 광열비 절감 금액도 크게 효과가 있습니다. 그러나 건조 기능 자체가 많은 에너지를 사용하기 때문에 가능한 건조 기능을 사용하지 않는 것이 바람직합니다.",   lifestyle:"",   season:"wss"};
	...
	D6.scenario.defMeasures['mLILED'] = { mid:"502",  name:"mLILED",  title:"LED로 바꿔",  easyness:"2",  refCons:"consLI",  titleShort:"LED 전구", level:"",  figNum:"5",  lifeTime:"40000h",  price:"2000",  roanShow:"",  standardType:"電球",  subsidy :"",  advice:"전구와 같은 소켓을 사용하고 전구가 만료 될 때 그대로 바꿔 수 있습니다. 전기 소비를 80 % 줄일 수 있으며, 수명은 40 배 이상입니다.",   lifestyle:"",   season:"wss"};
	...
	D6.scenario.defMeasures['mTVreplace'] = { mid:"601",  name:"mTVreplace",  title:"에너지 절약 성능이 높은 TV에 사서 바꾸는",  easyness:"2",  refCons:"consTV",  titleShort:"절약 에네테레비 구매", level:"",  figNum:"7",  lifeTime:"10",  price:"40000",  roanShow:"",  standardType:"普及型",  subsidy :"",  advice:"에너지 절약 성능이 높아지고 있기 때문에 같은 크기이면 절반 이하의 소비 전력이 될 텔레비전이 판매되고 있습니다. 매장에서는 가급적 연간 전기 요금이 싼 것을 선택하도록하십시오.",   lifestyle:"",   season:"wss"};
	...
	D6.scenario.defMeasures['mRFreplace'] = { mid:"701",  name:"mRFreplace",  title:"냉장고를 에너지 절약형으로 사서 바꾸는",  easyness:"2",  refCons:"consRF",  titleShort:"에너지 절약 냉장고", level:"",  figNum:"2",  lifeTime:"10",  price:"150000",  roanShow:"",  standardType:"普及型",  subsidy :"",  advice:"이전 모델에 비해 절반 정도의 전기에서 사는 에너지 절약형 냉장고가 있습니다. 선택할 때에는 통일 절약 라벨의 ★ 마크의 수가 많은 것이나 연간 전기 요금 표시를 참고로 에너지 절약을 선택하십시오.買換 때 오래된 냉장고는 가전 재활용 제도에서 물러 받도록합시다.",   lifestyle:"",   season:"wss"};
	...
	D6.scenario.defMeasures['mCRreplace'] = { mid:"801",  name:"mCRreplace",  title:"친환경 자동차에 사서 바꾸는",  easyness:"2",  refCons:"consCR",  titleShort:"차량 교체", level:"",  figNum:"21",  lifeTime:"8",  price:"1800000",  roanShow:"",  standardType:"普及型",  subsidy :"エコカーの導入にあたっては、「減税」のメリットが得られます。",  advice:"하이브리드 및 전기 자동차 이외에도 기술 개선으로 기존의 연료 소비가 절반 정도에서 끝나는 저연비 자동차가 개발되어 판매되고 있습니다. 구입시에는 연비를 고려하여 선택하십시오.",   lifestyle:"",   season:"wss"};
	D6.scenario.defMeasures['mCRreplaceElec'] = { mid:"802",  name:"mCRreplaceElec",  title:"전기 자동차를 도입하는",  easyness:"1",  refCons:"consCR",  titleShort:"전기 자동차", level:"",  figNum:"21",  lifeTime:"7",  price:"3000000",  roanShow:"",  standardType:"",  subsidy :"",  advice:"가솔린 대신 충전식 배터리에 전기를위한 엔진 대신 모터를 돌려 달립니다. 엔진에 비해 효율이 높고, 충분히 실용적인 차량으로 판매되고 있습니다. 그러나 충전 스탠드는 아직 적고, 충전에 시간이 걸리기 때문에 야간에 충전 해두면 편리합니다.",   lifestyle:"",   season:"wss"};
