...
$lang['home_easy_top3sm']='※完全無料です。名前やメールアドレスなど、あなたを特定する情報の入力は必要ありません。この診断ソフトは、計算ロジック自体を端末にダウンロードして行うため、入力した値を利用端末以外に送ることはありません。このページは利用状況を把握するためにGoogle Analiticsを使用しています。';
